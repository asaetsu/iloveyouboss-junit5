...
//   }
    ...
    public void binarySearchFindsMidpoint() {
        assertThat(array.binarySearch(40, TEN_THRU_SEVENTY, 7)).isEqualTo(3);
    }

    @Test
    public void binarySearchAnswersInsertAfterWhenNotFound() {
        assertThat(array.binarySearch(44, TEN_THRU_SEVENTY, 7)).isEqualTo(3);
        assertThat(array.binarySearch(2, TEN_THRU_SEVENTY, 7)).isEqualTo(-1);
        assertThat(array.binarySearch(77, TEN_THRU_SEVENTY, 7)).isEqualTo(6);
    }

    @Test
    public void binarySearchLessThanMid() {
        assertThat(array.binarySearch(20, TEN_THRU_SEVENTY, 7)).isEqualTo(1);
    }

    @Test
    public void binarySearchMoreThanMid() {
        assertThat(array.binarySearch(50, TEN_THRU_SEVENTY, 7)).isEqualTo(4);
    }

    @Test
    public void binarySearchKeepsTrying() {
        assertThat(array.binarySearch(30, TEN_THRU_SEVENTY, 7)).isEqualTo(2);
    }
}
